...
$sql="INSERT INTO TblTourPackages(PackageName,PackageType,PackageLocation,PackagePrice,PackageFetures,PackageDetails,PackageImage,spotid) VALUES(:pname,:ptype,:plocation,:pprice,:pfeatures,:pdetails,:pimage,:plocid)";
...
$query->bindParam(':plocid',$plocid,PDO::PARAM_STR);
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Location  Id</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="locid" id="packagelocation" placeholder=" Location Id" required>
									</div>
								</div>
