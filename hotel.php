...
{	?>
			<div class="rom-btm">
				...
				<div class="col-md-6 room-midle wow fadeInUp animated" data-wow-delay=".5s">
					<h4>Hotel Name: <?php echo htmlentities($result->name);?></h4>
					<h6>Location : <?php echo htmlentities($result->location);?></h6>
					<p><b>Contact Number :</b> <?php echo htmlentities($result->number);?></p>
				</div>
				<div class="col-md-3 room-right wow fadeInRight animated" data-wow-delay=".5s">
					<h5>USD <?php echo htmlentities($result->cost);?></h5>
					<a href="thankyou.php" class="view">Book</a>
				</div>
